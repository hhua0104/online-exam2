...
<div class="row-fluid">
	<div class="toolcontent">
		<div class="container-fluid footcontent">
			<div class="span2" style="margin-bottom:0;padding-bottom: 0;padding-top: 0;margin-top: 0;">
				<ul class="unstyled" style="margin-bottom:0;padding-bottom: 0;padding-top: 0;margin-top: 0;">
					<li><h4 style="margin-bottom:0;padding-bottom: 0;padding-top: 0;margin-top: 0;"><table style="width:100%">
								<tr>
									<td>
